...
<html lang="pt-br">
    <head>
        ...
        <title>Cálcular a Média com conceito</title>
...
<body>
    <div class="container mt-5">
        ...
        <form method="POST" class="mt-4">
            <div class="mb-3">
                <label for="media1" class="form-label">Média 1</lable>
                <input type="number" step="0.1" class="form-control" id="media1" name="media1" required>
</div>
            <div class="mb-3">
                <label for="media2" class="form-label">Média 2</label>
                <input type="number" step="0.1" class="form-control" id="media2" name="media2" required>
</div>
            <div class="mb-3">
                <label for="media3" class="form-label">Média 3</label>
                <input type="number" step="0.1" class="form-control" id="media3" name="media3" required>
</div>
<div class="mb-3">
                <label for="media4" class="form-label">Média 4</label>
                <input type="number" step="0.1" class="form-control" id="media4" name="media4" required>
</div>
<button type="submit" class="bnt bnt-secondary">Calcular a Média</button>
</form>
    ...
    if ($conceito == 'C') {
        ...
        <form method="POST" class="mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.1" class="form-control" id="recuperacao" name="recuperacao" required>
            </div>
